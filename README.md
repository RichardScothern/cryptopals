...
FBOpenSSH is a fork of OpenSSH with a set of patches developed at Facebook and used in production for the past few years.
 ...
 * Certificate handling.  Facebook [uses SSH certificates](https://engineering.fb.com/security/scalable-and-secure-access-with-ssh/) extensively and some changes to OpenSSH are required for this.
